  ...
  _createClass(FormHandler, [{
    ...
    value: function init(submitCallBack) {
      ...
      this.$formElement.submit(function (event) {
        ...
        var form = (0, _jquery2.default)(_this.$formElement)[0];
        var data = {};
...
new _formhandler2.default(FORM_SELECTOR).init();
